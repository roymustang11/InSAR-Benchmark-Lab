...
| --- | --- | --- |
| [`01_project_orientation.ipynb`](01_project_orientation.ipynb) | Runnable orientation | Study area, scientific question, data sources, workflow map. |
| [`02_hyp3_or_opera_to_timeseries.ipynb`](02_hyp3_or_opera_to_timeseries.ipynb) | Runnable metadata search | Search OPERA DISP-S1 products and build a small inventory table. |
